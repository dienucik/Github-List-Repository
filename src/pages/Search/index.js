...
const Search = () => {
    ...
    const Repository = ({
        ...
        return ( <
            ...
            <
            TouchableOpacityDetailsRepo onPress = {
                () => navigate('Details', {
            ...
            ViewArrowToDetailsRepo >
            <
            IconArrowRightToDetails name = "angle-right"
            color = "#ddd"
            size = {
                30
            }
    ...
    return ( <
            ...
            <
            TextSearchInput placeholder = "repository name"
            underlineColorAndroid = "transparent"
            value = {
                repositorySearch
            }
            onChangeText = {
                e => setRepositorySearch(e)
            }
            onSubmitEditing = {
                async () => await handleSearch('HANDLE_FORM')
            }
            /> < /
            SectionFormView >
            ...
            ButtonSearch style = {
                {
                    backgroundColor: ((loadingRepos || repositorySearch === '') ? '#ccc' : '#209400')
                }
            }
            disabled = {
                (loadingRepos || loadingRepos || repositorySearch === '') ? true : false
            }
            onPress = {
                async () => await handleSearch('HANDLE_FORM')
            } >
            ...
            onEndReached = {
                async () => handleSearch('HANDLE_PAGE')
            }
